 ...
 * than their permalink implies (legacy URLs). AP Physics C units use nested permalinks under
 * `/notes/ap/ap-physics-c-em/` and `/notes/ap/ap-physics-c-mechanics/` instead. `sourcePrefix`
 * is the Astro collection entry id prefix (lowercase slug, e.g. `aps/ap-calc/`), not the on-disk folder name.
 *
