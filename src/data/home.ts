...
export const physicsGroups: UnitGroup[] = [
  {
    ...
    status: 'in-progress',
    units: [
      { label: 'Kinematics', href: '/notes/ap/ap-physics-c-mechanics/kinematics/' },
      { label: 'Forces', href: '/notes/ap/ap-physics-c-mechanics/forces/' },
      { label: 'Work and energy', href: '/notes/ap/ap-physics-c-mechanics/work/' },
      { label: 'Linear momentum', href: '/notes/ap/ap-physics-c-mechanics/linearmomentum/' },
      { label: 'Torque', href: '/notes/ap/ap-physics-c-mechanics/torque/' },
      { label: 'Oscillations', href: '/notes/ap/ap-physics-c-mechanics/oscillations/' },
      { label: 'Rotational momentum', href: '/notes/ap/ap-physics-c-mechanics/rotationalmomentum/' },
    ],
  },
  {
    ...
    status: 'in-progress',
    units: [
      { label: 'Electrostatics', href: '/notes/ap/ap-physics-c-em/electrostatics/' },
      { label: 'Electric potential', href: '/notes/ap/ap-physics-c-em/electricpot/' },
      { label: 'Conductors and capacitors', href: '/notes/ap/ap-physics-c-em/condcap/' },
      { label: 'Circuits', href: '/notes/ap/ap-physics-c-em/circuits/' },
      { label: 'Magnetism', href: '/notes/ap/ap-physics-c-em/magnetism/' },
      { label: 'EM induction', href: '/notes/ap/ap-physics-c-em/eminduction/' },
    ],
  },
  {
    title: 'F=ma prep',
